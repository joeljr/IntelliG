...
source ~/.intellig/multiple_cursors.vim
...
"""""""""""""""""""""""""
" Ai - Manage AI assistant
source ~/.intellig/intellij/ai.vim
...
" Debug - debug code
source ~/.intellig/intellij/debug.vim

" Run - Run, Test, Profile, etc...
source ~/.intellig/intellij/run.vim
...
" Git - manage git
source ~/.intellig/intellij/git.vim

" History - navigate history
source ~/.intellig/intellij/history.vim

" Keybinds for dealing with ~/.ideavimrc
source ~/.intellig/ideavimrc.vim

" Keybinds for intellij
source ~/.intellig/intellij/intellij.vim

" keybinds for navigating around
source ~/.intellig/intellij/jump.vim

" Menus - mappings to various menus
source ~/.intellig/intellij/menus.vim

" Project - navigate and manage project files
source ~/.intellig/intellij/project.vim

" Refactor - refactor code
source ~/.intellig/intellij/refactor.vim
...
source ~/.intellig/plugins_ideavim/textobj_entire.vim
